...
class TestUser(unittest.TestCase):
	...
	def setUp(self):
		...
		'''
		self.new_user = User('antony','mwa\'nik\'a','pswd3250')
...
class TestCredentials(unittest.TestCase):
	...
	def test_check_user(self):
		...
		self.new_user = User('antony','mwa\'nik\'a','pswd3250')
		self.new_user.save_user()
		user2 = User('antony','mwa\'nik\'i','pswd3250')
		user2.save_user()
	...
	def setUp(self):
		...
		'''
		self.new_credential = Credential('antony','Facebook','mrt','pswd3250')

	def test__init__(self):
		'''
		Test to if check the initialization/creation of credential instances is properly done
		'''
		self.assertEqual(self.new_credential.user_name,'antony')
		self.assertEqual(self.new_credential.site_name,'Facebook')
		self.assertEqual(self.new_credential.account_name,'mrt')
		self.assertEqual(self.new_credential.password,'pswd3250')
	...
	def test_copy_credential(self):
		...
		self.assertEqual('pswd980p',pyperclip.paste())
